...
#define DUAL_FUNC_2 LT(2, KC_F16)
#define DUAL_FUNC_3 LT(13, KC_I)
#define DUAL_FUNC_4 LT(4, KC_F5)
#define DUAL_FUNC_5 LT(1, KC_L)
#define DUAL_FUNC_6 LT(8, KC_F17)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    TG(4),          DUAL_FUNC_0,    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_2,    OSL(3),         
    LT(2, KC_TAB),  KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,                                           KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           ALL_T(KC_BSPC), 
    MT(MOD_LCTL, KC_ESCAPE),KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        MT(MOD_RALT, KC_QUOTE),
    DUAL_FUNC_1,    KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       DUAL_FUNC_3,    
  ...
  [4] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_GRAVE,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_BSLS,        KC_TRANSPARENT, 
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    [0] = { {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {112,255,250}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {112,255,250}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,120,251}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {112,255,250}, {112,255,250}, {112,255,250} },

    [1] = { {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {112,255,250}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {112,255,250}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,120,251}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {112,255,250}, {0,0,255}, {0,0,255}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250} },

    [2] = { {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {133,155,246}, {112,255,250}, {193,92,255}, {193,92,255}, {193,92,255}, {112,255,250}, {133,59,230}, {112,255,250}, {12,132,255}, {12,132,255}, {0,255,255}, {68,39,186}, {133,59,230}, {112,255,250}, {40,255,255}, {40,255,255}, {0,0,255}, {0,0,255}, {133,59,230}, {112,255,250}, {112,255,250}, {133,59,230}, {133,59,230}, {133,59,230}, {133,59,230}, {112,255,250}, {0,218,204}, {193,92,255}, {193,92,255}, {193,92,255}, {193,92,255}, {112,255,250}, {112,255,250}, {0,0,255}, {0,0,255}, {0,0,255}, {133,155,246}, {112,255,250}, {112,255,250}, {112,255,250}, {194,206,226}, {194,206,226}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250} },

    [3] = { {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {112,255,250}, {112,255,250}, {40,255,255}, {40,255,255}, {40,255,255}, {40,255,255}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250}, {112,255,250} },

    [4] = { {0,255,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255} },
